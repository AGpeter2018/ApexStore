                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {categories.map((cat, i) => (
                        <Link
                            ...
                            className="group relative h-[400px] sm:h-[500px] lg:h-[600px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden bg-slate-900 border border-white/5 hover:border-orange-500/30 transition-all duration-700 shadow-2xl"
                        >
