            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="lg:w-64 flex-shrink-0">
                        ...
                        <div className={`bg-white rounded-lg shadow-md p-6 sticky top-4 ${showFilters ? 'block' : 'hidden lg:block'}`}>
                                    ...
                                    {products.map((product) => {
                                        ...
                                        return (
                                            <Link
                                                ...
                                                className="group"
                                            >
                                                <div className={`bg-white rounded-xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 ${viewMode === 'list' ? 'flex' : ''
                                                    }`}>
                                                    {/* Product Image */}
